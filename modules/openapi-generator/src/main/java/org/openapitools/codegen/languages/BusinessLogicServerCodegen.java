...
public class BusinessLogicServerCodegen extends AbstractJavaCodegen
    implements BeanValidationFeatures, PerformBeanValidationFeatures, OptionalFeatures {
    private final Logger LOGGER = LoggerFactory.getLogger(BusinessLogicServerCodegen.class);
    ...
    public BusinessLogicServerCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "business-logic";
